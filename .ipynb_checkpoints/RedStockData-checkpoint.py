...
def main():
    ...
    print(f"Put http://localhost:{listen_port} in the redirect uri field and click create app")
    #client_id = input(
    ...
    reddit = praw.Reddit(
        ...
        client_id="ynxIzj1XQZ4opg",
        client_secret="rj4DDjgeoB-8umUv9ScUqXaqTbZ8rQ",
